...
import PdfForm from "@/components/shared/contents/pdf-form";
...
export default function PDF() {
  ...
  return (
    <Layout title={t("contents.pdf.header_title")}>
      <Layout.Container>
        <AddonController addon="courses.contents.pdf">
          <Breadcrumbs className="mb-2 overflow-x-auto overflow-y-hidden whitespace-nowrap pb-4">
            ...
            <Typography.Paragraph as="span">{t("contents.pdf.header_title")}</Typography.Paragraph>
          </Breadcrumbs>
          <PdfForm defaultValues={{ id: 1, updated_at: new Date(), created_at: new Date(), temp_values: true }} />
        </AddonController>
      </Layout.Container>
    </Layout>
  );
