...
export default function Create() {
  ...
  return (
    <Layout>
      <Head>
        <title>{t("contents.survey.add_survey")}</title>
      </Head>
      ...
      <Layout.Container>
        <AddonController addon="surveys">
          <Breadcrumbs className="mb-2 overflow-x-auto overflow-y-hidden whitespace-nowrap pb-4">
            ...
            <Typography.Paragraph as="span">{t("contents.survey.add_survey")}</Typography.Paragraph>
          </Breadcrumbs>
          <SurveyForm defaultValues={{ id: 1, updated_at: new Date(), created_at: new Date(), temp_values: true }} />
        </AddonController>
      </Layout.Container>
    </Layout>
  );
