...
import QuizForm from "@/components/shared/contents/quiz-form";
      ...
      <Layout.Container>
        <AddonController addon="courses.contents.quiz">
          <Breadcrumbs className="mb-2 overflow-x-auto overflow-y-hidden whitespace-nowrap pb-4">
            ...
            <Typography.Paragraph as="span">{t("contents.quiz.header_title")}</Typography.Paragraph>
          </Breadcrumbs>
          <QuizForm defaultValues={{ id: 1, updated_at: new Date(), created_at: new Date(), temp_values: true }} />
        </AddonController>
      </Layout.Container>
    </Layout>
  );
