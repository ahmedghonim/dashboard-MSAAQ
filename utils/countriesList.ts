...
export const minimalCountriesList = Countries.map((country) => {
  return {
    label: country.ar_name,
    en_name: country.name,
    value: {
      name: country.ar_name,
      iso2: country.iso_3166_1_alpha2.toLocaleLowerCase(),
      dialCode: country.calling_code,
      preferred: preferred.includes(country.iso_3166_1_alpha2.toLocaleLowerCase()),
      flag: `https://www.flagpictures.com/static/flags/vector/${country.iso_3166_1_alpha2.toLocaleLowerCase()}.svg`
    }
  };
});
