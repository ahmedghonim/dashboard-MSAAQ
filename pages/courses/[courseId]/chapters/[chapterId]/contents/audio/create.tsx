...
import AudioForm from "@/components/shared/contents/audio-form";
...
export default function Audio() {
  ...
  return (
    <Layout title={t("contents.audio.header_title")}>
      <Layout.Container>
        <AddonController addon="courses.contents.audio">
          <Breadcrumbs className="mb-2 overflow-x-auto overflow-y-hidden whitespace-nowrap pb-4">
            ...
            <Typography.Paragraph as="span">{t("contents.audio.header_title")}</Typography.Paragraph>
          </Breadcrumbs>
          <AudioForm defaultValues={{ id: 1, updated_at: new Date(), created_at: new Date(), temp_values: true }} />
        </AddonController>
      </Layout.Container>
    </Layout>
  );
